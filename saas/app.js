...
mongoose.connect('mongodb://localhost:27017/saas-app-db');
...
app.use(expressSession({
  //Putting this in the .env is not working
...
app.get('/billing', function(req,res,next){
  ...
  stripe.checkout.sessions.create({
    ...
    mode: 'subscription',
    success_url: 'http://localhost:3000/billing?session_id=prod_HLYIp5am5EyVhC',
...
app.post('/login-page', passport.authenticate("local",{ 
